...
export default class RegistrationForm {
    ...
    passwordHandler() {
        ...
        this.passwordImmediately()
        clearTimeout (this.username.timer)
        this.password.timer = setTimeout(() => this.passwordfterDelay(), 800)
    }  
    ...
    usernameImmediately() {
        // google regular expressions in javaScript to undertand the condition below
