...
Follow.prototype.validate = async function(action) {
    ...
    if (followedAccount) {
        ...
        this.errors.push("You can follow a user that does not exist.")
    }
    ...
    if (action == "delete") {
        if(!doesFollowAlreadyExists) {this.errors.push("You cannot not stop following someone you do not already follow.")}
    }

    // should not be able to follow yourself

    if (this.followedId.equals(this.authorId)){this.errors.push("You can follow yourself.")}
}
